...
file_path = f'/Users/dood/Desktop/java_web_JS/python/crawling/알라딘 베스트셀러 1~400위(엑셀)_{d.year}_{d.month}_{d.day}.xlsx'
...
while True:
    ...
    for div_ss_book_box in div_ss_book_box_list:
        ...
        try:
            ...
            # 엑셀에 이미지 저장
            # worksheet.insert_image('배치할 셀 번호', 이미지제목, {'image_data': 바이크로 변환한 이미지, 기타 속성...})
